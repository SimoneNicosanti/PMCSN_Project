...
public class CenterStatistics {
    ...
    // private Map<QueuePriority, Long> personPerPriority; // Given the priority,
    // return the number of person served
    // private long numberOfServedGroup;
    // private Map<QueuePriority, Long> groupPerPriority; // Given the priority,
    // return the number of group served
    ...
    // private void updateNumberOfJobServed(int personServed, QueuePriority
    // priority) {
